...
2.  Type the following command to install the pre-requisite libraries
    ...
    <pre><b><u>Note:</u></b>Find more information on agent machine prerequisites <a href="https://github.com/Microsoft/vsts-agent/blob/master/docs/start/envubuntu.m">here</pre>
