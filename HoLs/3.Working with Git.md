...
3.  Leave your browser open and on the current page. Continue to the
    next exercise [**Running builds, Unit Tests and Code Coverage**](https://github.com/hsachinraj/vsts-javavmlabs/blob/master/HoLs/4.Running%20builds%2C%20Unit%20Tests%20and%20Code%20Coverage.md) where you’ll configure a Team Build.
