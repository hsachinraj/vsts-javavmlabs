...
10. Once your login is success you will be asked to enter the master password, enter the password of your choice and confirm the          passowrd then click **OK**. It is important to remember master password as it requires everytime you connect to your VSTS account.

    <img src="./images/git/image8a.png" width="485" height="373" />

11. Choose the **Team Project** (jdev) and select **Finish**

    <img src="./images/git/image9.png" width="434" height="190" />

11.  Eclipse will open a Secure Storage dialog. Enter a password and
...
12.  Now click **Close** in the **Add/Remove Team Foundation Server** dialog.

13.  In the **Add Existing Team Project** dialog, select the **Default
...
5.  On the **Clone Summary** page, click **Next**.

    <img src="./images/git/image16.png" width="377" height="124" />

6.  Enter your alternate credentials when prompted and click **OK**.

7.  On the **Select Project Import Wizard** page, click **Next**.

    <img src="./images/git/image17.png" width="257" height="281" />

8.  You don’t have any existing Eclipse projects so just click
    **Finish**.
...
9.  Open File Manager and navigate to the **/home/vmadmin** folder. Copy
...
10.  Copy or move them to your home folder **(/home/&lt;user name&gt;**)

    <img src="./images/git/image20.png" width="445" height="352" />

11.  Open myshuttle folder. Select all the files in the folder. Right
    click and select **Copy**

    <img src="./images/git/image21.png" width="403" height="251" />

12.  Go to the **jdev** folder and paste the copied files
