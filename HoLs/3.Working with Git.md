...
1.  If necessary, click the Home icon in Team Explorer window and  select the **Connect to a Team
    Foundation Server or team Service Account** radio button.
...
2. In the **Add Existing Team Project** dialog, click the
    **Servers** button.
