...
1.  Double-click the **Intranet Site Updates** feature to open the
    ...
    <img src="./images/backlog/image5.png" width="488" height="306" />

1.  Change the value of the **State** field from **New** to **In
    Progress**.

    <img src="./images/backlog/image6.png" width="290" height="77" />
...
2.  Select the **Iteration** field. Expand the combo-box to see the
    ...
    <img src="./images/backlog/image7.png" width="388" height="163" />
...
2.  In the **Description** field, type a short note like, **Complete
    ...
    <img src="./images/backlog/image8.png" width="356" height="200" />

1.  Click the links button on the right of the form.

    <img src="./images/backlog/image9.png" width="179" height="43" />

1.  Click the **New linked work item** button.

    <img src="./images/backlog/image10.png" width="192" height="89" />
...
2.  In the **Title** field, enter **Site Fit & Finish**.
    ...
    <img src="./images/backlog/image11.png" width="200" height="211" />
...
2.  When ready click **Save and close**.
    ...
    <img src="./images/backlog/image12.png" width="160" height="34" />
...
1.  Move your mouse and hover over the card and you’ll get a combo-box
    ...
    <img src="./images/backlog/image24.png" width="152" height="77" />

1.  Assign the task to yourself.

    One more thing you need to do is add an estimate for each work item.

2.  Open each task and change the **Remaining Work field** to **1** and
    then click the **Save and close** button like earlier.
...
1.  Drag and drop the **Add Master Branding** work item to the **In
    ...
    <img src="./images/backlog/image26.png" width="329" height="178" />
